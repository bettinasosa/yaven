            ...
            {[
              ...
              <a
                ...
                style={{
                  ...
                  boxShadow: "inset 0 1px 0 rgba(227,213,187,0.18), 0 2px 8px rgba(0,0,0,0.18)",
                ...
                onMouseEnter={e => {
                  ...
                  el.style.boxShadow = "inset 0 1px 0 rgba(227,213,187,0.28), 0 8px 20px rgba(0,0,0,0.28)"
                }}
                onMouseLeave={e => {
                  const el = e.currentTarget as HTMLElement
                  el.style.transform = ""
                  el.style.background = "rgba(227,213,187,0.08)"
                  el.style.boxShadow = "inset 0 1px 0 rgba(227,213,187,0.18), 0 2px 8px rgba(0,0,0,0.18)"
                }}
              >
                {s.icon}
              </a>
        ...
        <div>
          ...
          <div className="flex flex-col gap-[10px]">
            {[
              ...
              { label: "Book a call ↗",   href: "https://calendly.com/nickprice2000/yaven-support" },
            ].map(s => (
              <a
                key={s.label}
                href={s.href}
