  ...
  return (
    <>
      ...
      {open && (
        ...
        >
          <div
            className="relative bg-white rounded-3xl p-8 sm:p-10 max-w-md w-full shadow-2xl"
            onClick={(e) => e.stopPropagation()}
          >
            <button
              onClick={handleClose}
              className="absolute top-5 right-6 text-zinc-400 hover:text-zinc-700 transition-colors text-2xl leading-none cursor-pointer"
            >
              ×
            </button>
